...
def main():
    ...
    parser.add_argument("--save_json", type=str, default="/home/YiChen/uq/dev_fig/fig_statistic/manhattan_layerwise.json", help="可选：保存结果到该 JSON 路径")
    ...
    for example in tqdm(dataset, total=len(dataset)):
        ...
        result = tool._accumulate_last_token_layerwise(contrib_mats, seq_len)
